    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_jwk', models.TextField(blank=True, help_text="Tool's generated Public key (from the field above) presented as JWK.", null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issuer', models.CharField(help_text="This will usually look something like 'http://example.com'. Value provided by LTI 1.3 Platform", max_length=255)),
                ('client_id', models.CharField(help_text='Value provided by LTI 1.3 Platform', max_length=255)),
                ('use_by_default', models.BooleanField(default=False, help_text='This iss config will be used in case if client-id was not passed')),
                ...
                ('auth_audience', models.CharField(blank=True, help_text="The platform's OAuth2 Audience (aud). Usually could be skipped", max_length=1024, null=True)),
                ...
                ('key_set', models.TextField(blank=True, help_text="In case if platform's JWKS endpoint somehow unavailable you may paste JWKS here. Value provided by LTI 1.3 Platform", null=True)),
                ('deployment_ids', models.TextField(help_text='List of Deployment IDs. Example: ["test-id-1", "test-id-2", ...] Each value is provided by LTI 1.3 Platform. ')),
                ('tool_key', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='lti_tools', to='lti1p3_tool_config.ltitoolkey')),
            ],
            options={
